...
extension ProductService {
    ...
    func getIngredientsOCR(forBarcode: String, productLanguageCode: String, onDone: @escaping (String?, Error?) -> Void) {
        ...
        let request = Alamofire.request("\(Endpoint.get)/cgi/ingredients.pl?process_image=1&ocr_engine=google_cloud_vision", method: .get, parameters: params, encoding: URLEncoding.default)
